...
class MacProViewController: UIViewController {
    @IBOutlet weak var macproImage: UIImageView!
    ...
    @IBAction func shareTapped(_ sender: UIButton) {
        ...
        let activityVC = UIActivityViewController(activityItems: [ self.macproImage.image ,self.ssdTextField.text , self.ramTextField.text , self.processorTextField.text], applicationActivities: nil)
...
extension MacProViewController : UIPickerViewDelegate , UIPickerViewDataSource {
