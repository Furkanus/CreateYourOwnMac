//
//  MacBookProDetailViewController.swift
//  CreateYourOwnMac
//
...
class MacBookProDetailViewController: UIViewController {
    @IBOutlet weak var MacbookProImage: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        ssdTextField.placeholder = "Select your MacbookPro's ssd"
        ramTextField.placeholder = "Select your MacbookPro's ram"
        processorTextField.placeholder = "Select your MacbookPro's processor"
    ...
    @IBAction func shareTapped(_ sender: UIButton) {
        let activityVC = UIActivityViewController(activityItems: [ self.MacbookProImage.image ,self.ssdTextField.text , self.ramTextField.text , self.processorTextField.text], applicationActivities: nil)
...
extension MacBookProDetailViewController : UIPickerViewDelegate , UIPickerViewDataSource {
