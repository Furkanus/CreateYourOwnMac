...
class MacMiniViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        ssdTextField.placeholder = "Select your MacMini's ssd"
        ramTextField.placeholder = "Select your MacMini's ram"
        processorTextField.placeholder = "Select your MacMini's processor"
    ...
    @IBAction func shareTapped(_ sender: UIButton) {
        ...
        let activityVC = UIActivityViewController(activityItems: [ self.macMiniImage.image ,self.ssdTextField.text , self.ramTextField.text , self.processorTextField.text], applicationActivities: nil)
...
extension MacMiniViewController : UIPickerViewDelegate , UIPickerViewDataSource {
